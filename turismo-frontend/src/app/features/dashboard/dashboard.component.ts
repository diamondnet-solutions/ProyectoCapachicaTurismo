...
@Component({
  ...
  template: `
      <div class="space-y-6">
        <h1 class="text-2xl font-bold text-gray-900 lg:text-3xl">Panel de Control</h1>
          ...
          <div class="rounded-lg bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ summary?.total_users || 0 }}</p>
              </div>
          ...
          <div class="rounded-lg bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ summary?.total_roles || 0 }}</p>
              </div>
            ...
            <div class="mt-4">
              <a routerLink="/admin/roles" class="text-sm font-medium text-primary-600 hover:text-primary-700">
                Ver todos los roles →
              </a>
            </div>
          </div>
          ...
          <div class="rounded-lg bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-gray-900">{{ summary?.total_permissions || 0 }}</p>
              </div>
            ...
            <div class="mt-4">
              <a routerLink="/admin/permissions" class="text-sm font-medium text-primary-600 hover:text-primary-700">
            ...
            <div class="flex flex-col h-full justify-between">
              ...
              <div class="mt-4 space-y-2">
                <a 
                  ...
                  class="block w-full rounded-md bg-primary-600 px-4 py-2 text-center text-sm font-medium text-white hover:bg-primary-700"
                >
                  Nuevo Usuario
                </a>
                <a 
                  routerLink="/admin/roles/create" 
                  class="block w-full rounded-md bg-white px-4 py-2 text-center text-sm font-medium text-primary-700 border border-primary-600 hover:bg-primary-50"
                >
                  Nuevo Rol
                </a>
              </div>
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                @for (roleData of summary?.users_by_role; track roleData.role) {
                  <div class="rounded-lg border border-gray-200 p-4">
                    <div class="flex items-center justify-between">
                      <span class="text-sm font-medium text-gray-600">{{ roleData.role }}</span>
        ...
        <div class="rounded-lg bg-white p-6 shadow-sm">
          <div class="flex items-center justify-between">
            ...
            <a routerLink="/admin/users" class="text-sm font-medium text-primary-600 hover:text-primary-700">
              Ver todos →
            </a>
          </div>
